...
class BayesClassifier:
    ...
    def train(self) -> None:
        ...
        Train here means generating `pos_freq/neg_freq` dictionaries with frequencies of
        ...
        # once you have gone through all the files, you will need to save the frequency dictionaries to
    ...
    def classify(self, text: str) -> str:
        """Classifies given text as negative, positive, or neutral from calculating the
        ...
        Returns:
            classification, either negative, positive, or neutral
        """
    ...
    def update_dict(self, words: List[str], freqs: Dict[str, int]) -> None:
        ...
        By updating we mean incrementing the count of each word in words in the dictionary.
        If any word in words is not currently in the dictionary, you'll need to add it with a count of 1.
        (if a word is in words multiple times you'll increment it as many times as it appears)
